      ...
      <div className="w-full max-w-lg bg-gray-800 p-8 rounded-lg shadow-xl">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          <input
            ...
            placeholder="Title"
            required
            className="w-full p-3 bg-gray-700 text-white rounded-md border border-gray-600 focus:ring-2 focus:ring-blue-500"
          />
          <textarea
            value={description}
          ...
          <div className="flex space-x-4">
            <button
              type="submit"
              className="w-full bg-blue-600 hover:bg-blue-700 p-3 rounded-md text-white font-bold transition"
            >
              Save
            </button>
            <button
              type="button"
              onClick={() => navigate("/")}
              className="w-full bg-red-600 hover:bg-red-700 p-3 rounded-md text-white font-bold transition"
            >
              Cancel
            </button>
          </div>
