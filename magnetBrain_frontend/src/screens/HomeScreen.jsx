...
const HomeScreen = () => {
  ...
  return (
    <div className="h-full bg-gray-900 text-gray-200 p-8 flex justify-center items-center">
      <div className="w-full max-w-5xl bg-gray-800 p-6 rounded-lg shadow-xl">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button className="bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded text-white transition" onClick={() => navigate("/task")}>Create Task</button>
          </div>
        </div>
